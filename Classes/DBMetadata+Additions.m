...
//
//  Originally created by Joe Ricioppo
//
...
{	
	return [NSString stringWithFormat:@"%@ - %@", NSStringFromClass([self class]), [[self dictionaryRepresentation] descriptionWithLocale:nil indent:0]];
}
